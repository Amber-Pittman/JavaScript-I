...
const car33 = function(inventory, id) {
    let lookup = inventory.find(function() {
        this.id === 33;
    } 
    console.log( `Car ${lookup.id} is a ${lookup.car_year} ${lookup.car_make} ${found.car_model}`);
}
//onsole.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );
